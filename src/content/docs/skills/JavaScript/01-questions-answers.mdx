...
import  VideoDetails from "@components/VideoDetail.astro";
...
Use **WebSockets** to open a two-way communication channel between browser and server. <VideoDetails videoId="3q4mZTnaTzg" />
